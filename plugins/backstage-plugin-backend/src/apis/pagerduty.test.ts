...
describe('PagerDuty API', () => {
  ...
  describe('getAllEscalationPolicies', () => {
    it.each(testInputs)('should return ok', async () => {
      ...
      mocked(fetch).mockReturnValue(
        mockedResponse(200, {
          escalation_policies: [{ id: expectedId, name: expectedName }],
        }),
      );
    ...
    it.each(testInputs)(
      'should NOT list escalation policies when caller provides invalid arguments',
      async () => {
    ...
    it.each(testInputs)(
      'should NOT list escalation policies when correct credentials are not provided',
      async () => {
    ...
    it.each(testInputs)(
      'should NOT list escalation policies when account does not have abilities to perform the action',
      async () => {
    ...
    it.each(testInputs)(
      'should NOT list escalation policies when user is not allowed to view the requested resource',
      async () => {
    ...
    it.each(testInputs)('should work with pagination', async () => {
      ...
      const expectedName = [
        'Test Escalation Policy 1',
        'Test Escalation Policy 2',
        'Test Escalation Policy 3',
        'Test Escalation Policy 4',
        'Test Escalation Policy 5',
        'Test Escalation Policy 6',
        'Test Escalation Policy 7',
        'Test Escalation Policy 8',
        'Test Escalation Policy 9',
        'Test Escalation Policy 10',
      ];
      const expectedAccount = 'testaccount';
  ...
  describe('getOncallUsers', () => {
    it.each(testInputs)(
      'should return list of users ordered by name ASC from escalation policy level 1',
      async () => {
    ...
    it.each(testInputs)(
      'should return single user from escalation policy level 1',
      async () => {
        const escalationPolicyId = '12345';
        const expectedResponse = [
          {
    ...
    it.each(testInputs)(
      'should return relevant users from escalation policy level 1 even if another level is returned first',
      async () => {
        const escalationPolicyId = '12345';
        const expectedResponse = [
          {
    ...
    it.each(testInputs)(
      'should return list of users ordered by name ASC from other escalation levels when level 1 is empty',
      async () => {
        const escalationPolicyId = '12345';
        const expectedResponse = [
          {
    ...
    it.each(testInputs)(
      'should return list of users ordered by name ASC without duplicates',
      async () => {
        const escalationPolicyId = '12345';
        const expectedResponse = [
          {
  ...
  describe('getServices', () => {
    describe('getServicesByIntegrationKey', () => {
      it.each(testInputs)(
        "should return service when 'integration_key' is provided",
        async () => {
      ...
      it.each(testInputs)(
        'should NOT get service when caller provides invalid arguments',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(400, {}));
      ...
      it.each(testInputs)(
        'should NOT get service when correct credentials are not provided',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(401, {}));
      ...
      it.each(testInputs)(
        'should NOT get service if credentials do not provided the required permissions',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(403, {}));
      ...
      it.each(testInputs)(
        'should NOT get service if service does not exist',
        async () => {
    ...
    describe('getAllServices', () => {
      it.each(testInputs)(
        'show return list of PagerDuty services',
        async () => {
          const expectedResponse: PagerDutyService[] = [
            {
              id: 'S3RV1CE1D',
      ...
      it.each(testInputs)(
        'should NOT get services when caller provides invalid arguments',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(400, {}));
      ...
      it.each(testInputs)(
        'should NOT get services when correct credentials are not provided',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(401, {}));
      ...
      it.each(testInputs)(
        "should NOT get services when credentials are provided but don't have the necessary permissions",
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(403, {}));
    ...
    describe('getServicesById', () => {
      it.each(testInputs)(
        "should return service when 'service_id' is provided",
        async () => {
    ...
    describe('getChangeEvents', () => {
            ...
            integration: [
              {
                ...
                type: 'github',
                html_url:
                  'https://example.pagerduty.com/integrations/INT3GR4T10N_2D',
              },
            ],
          },
        ];
      ...
      it.each(testInputs)(
        'should NOT get change events when caller provides invalid arguments',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(400, {}));
      ...
      it.each(testInputs)(
        'should NOT get change events if credentials do not provide necessary permissions',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(403, {}));
    ...
    describe('getIncidents', () => {
          ...
          incidents: [
            {
              ...
              service: {
                ...
                escalation_policy: {
                  ...
                  html_url:
                    expectedResponse[0].service.escalation_policy.html_url,
              ...
              assignments: [
                {
                  assignee: {
                    ...
                    summary:
                      expectedResponse[0].assignments[0].assignee.summary,
                    name: expectedResponse[0].assignments[0].assignee.name,
                    email: expectedResponse[0].assignments[0].assignee.email,
                    avatar_url:
                      expectedResponse[0].assignments[0].assignee.avatar_url,
                    html_url:
                      expectedResponse[0].assignments[0].assignee.html_url,
                  },
                },
              ],
            },
            {
              ...
              service: {
                ...
                escalation_policy: {
                  ...
                  html_url:
                    expectedResponse[1].service.escalation_policy.html_url,
              ...
              assignments: [
                {
                  assignee: {
                    ...
                    summary:
                      expectedResponse[1].assignments[0].assignee.summary,
                    name: expectedResponse[1].assignments[0].assignee.name,
                    email: expectedResponse[1].assignments[0].assignee.email,
                    avatar_url:
                      expectedResponse[1].assignments[0].assignee.avatar_url,
                    html_url:
                      expectedResponse[1].assignments[0].assignee.html_url,
                  },
                },
              ],
            },
      ...
      it.each(testInputs)(
        'should NOT get incident when caller provides invalid arguments',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(400, {}));
      ...
      it.each(testInputs)(
        'should NOT get incidents when correct credentials are not provided',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(401, {}));
      ...
      it.each(testInputs)(
        'should NOT get incidents if credentials do not provide the required abilities',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(402, {}));
      ...
      it.each(testInputs)(
        'should NOT get incidents if credentials defined do not have the necessary permissions',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(403, {}));
      ...
      it.each(testInputs)(
        'should NOT get incidents if PagerDuty REST API limits have been reached',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(429, {}));
    ...
    describe('getStandards', () => {
      it.each(testInputs)(
        'should NOT get service standards when correct credentials are not provided',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(401, {}));
      ...
      it.each(testInputs)(
        'should NOT get service standards if credentials defined do not have the necessary permissions',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(403, {}));
      ...
      it.each(testInputs)(
        'should NOT get service standards if PagerDuty REST API limits have been reached',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(429, {}));
    ...
    describe('getMetrics', () => {
      it.each(testInputs)(
        'should NOT get service metrics if payload is malformed',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(400, {}));
      ...
      it.each(testInputs)(
        'should NOT get service metrics if PagerDuty REST API limits have been reached',
        async () => {
          mocked(fetch).mockReturnValue(mockedResponse(429, {}));
